...
namespace __Interop
{
	...
	{
		// Signature, SetFileAttributesPrivate, [fwd] [return] [EETypeRva:0x0003FAF4] bool__System.Boolean, [fwd] [in] [EETypeRva:0x00040DF0] string__wchar_t *, [fwd] [in] [EETypeRva:0x00040C5C] int__int, 
		[global::System.Runtime.InteropServices.McgPInvokeMarshalStub("System.IO.FileSystem, Version=4.1.1.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a", "Interop+Kernel32", "SetFileAttributesPrivate")]
		public static bool SetFileAttributesPrivate(
					string name, 
					int attr)
		{
			// Setup
			...
			fixed (char* pinned_name = name)
			{
				...
				// Call to native method
				unsafe___value = global::__Interop.kernel32_dll_PInvokes.SetFileAttributesPrivate(
									unsafe_name, 
									attr
								);
				global::System.Diagnostics.DebugAnnotations.PreviousCallContainsDebuggerStepInCode();
		...
		// Signature, SetThreadErrorMode, [fwd] [return] [EETypeRva:0x0003FAF4] bool__System.Boolean, [fwd] [in] [EETypeRva:0x00040C5C] uint__unsigned int, [fwd] [out] [managedbyref] [nativebyref] [EETypeRva:0x00040C5C] uint__unsigned int, 
		...
		// Signature, GetFileAttributesExPrivate, [fwd] [return] [EETypeRva:0x0003FAF4] bool__System.Boolean, [fwd] [in] [EETypeRva:0x00040DF0] string__wchar_t *, [fwd] [in] [EETypeRva:0x0004200C] __Interop_Kernel32_GET_FILEEX_INFO_LEVELS__System_IO_FileSystem__Interop_Kernel32_GET_FILEEX_INFO_LEVELS__System_IO_FileSystem, [fwd] [in] [out] [managedbyref] [nativebyref] [EETypeRva:0x000423F8] __Interop_Kernel32_WIN32_FILE_ATTRIBUTE_DATA__System_IO_FileSystem____Interop_Kernel32_WIN32_FILE_ATTRIBUTE_DATA__System_IO_FileSystem, 
		...
		// Signature, FindFirstFileExPrivate, [fwd] [return] [EETypeRva:0x00042750] Microsoft_Win32_SafeHandles_SafeFindHandle__System_IO_FileSystem____w64 int, [fwd] [in] [EETypeRva:0x00040DF0] string__wchar_t *, [fwd] [in] [EETypeRva:0x0004200C] __Interop_Kernel32_FINDEX_INFO_LEVELS__System_IO_FileSystem__Interop_Kernel32_FINDEX_INFO_LEVELS__System_IO_FileSystem, [fwd] [in] [out] [managedbyref] [nativebyref] [EETypeRva:0x000423F8] __Interop_Kernel32_WIN32_FIND_DATA__System_IO_FileSystem____Interop_Kernel32_WIN32_FIND_DATA__System_IO_FileSystem, [fwd] [in] [EETypeRva:0x0004200C] __Interop_Kernel32_FINDEX_SEARCH_OPS__System_IO_FileSystem__Interop_Kernel32_FINDEX_SEARCH_OPS__System_IO_FileSystem, [fwd] [in] [EETypeRva:0x00040C5C] System_IntPtr____w64 int, [fwd] [in] [EETypeRva:0x00040C5C] int__int, 
		...
		// Signature, FindClose, [fwd] [return] [EETypeRva:0x0003FAF4] bool__System.Boolean, [fwd] [in] [EETypeRva:0x00040C5C] System_IntPtr____w64 int, 
		...
		// Signature, FormatMessage, [fwd] [return] [EETypeRva:0x00040C5C] int__int, [fwd] [in] [EETypeRva:0x00040C5C] int__int, [fwd] [in] [EETypeRva:0x00040C5C] System_IntPtr____w64 int, [fwd] [in] [EETypeRva:0x00040C5C] uint__unsigned int, [fwd] [in] [EETypeRva:0x00040C5C] int__int, [fwd] [in] [EETypeRva:0x00040C5C] char___ptrwchar_t *, [fwd] [in] [EETypeRva:0x00040C5C] int__int, [fwd] [in] [EETypeRva:0x00041CEC] rg_System_IntPtr____w64 int *, 
	...
	{
		[global::System.Runtime.InteropServices.DllImport("kernel32.dll", EntryPoint="SetFileAttributesW", CallingConvention=global::System.Runtime.InteropServices.CallingConvention.Winapi)]
		public extern static int SetFileAttributesPrivate(
					ushort* name, 
					int attr);
